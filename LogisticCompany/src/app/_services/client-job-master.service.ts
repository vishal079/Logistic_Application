...
export class ClientJobMasterService {
  ...
  getAllSubCompany(company_id) {
    //debugger;
    this.spinner.show();
    console.log('getAllSubCompany() ' + company_id);
    let formData: FormData = new FormData();
    formData.append('company_id', company_id);
    this.http.post(this.eventRootURL + '/api/get/client_sub_company', formData).toPromise()
      .then((res: any) => {
        //debugger;
        //this.selectedParentCompany = company_id;
  ...
  postClientDetail() {
    ...
    return this.http.post(this.eventRootURL + '/api/company/create_job', formData);
  }

  putClientDetail() {
    let formData: FormData = this.CreateFormData();
    return this.http.post(this.eventRootURL + '/api/company/update_job', formData);
  }
  ...
  cancelJob(id) {
    ...
    return this.http.post(this.eventRootURL + '/api/company/cancel_job', formData);
  }

  refreshList() {
    this.spinner.show();
    this.http.post(this.eventRootURL + '/api/company/get/job', null).toPromise()
      .then((res: any) => {
  ...
  getAllClientJobs(status, deliveryDate) {
    ...
    this.http.post(this.eventRootURL + '/api/company/get/job', formData).toPromise()
      .then((res: any) => {
        debugger;
        this.listClientJob = res.data;
        this.spinner.hide();
