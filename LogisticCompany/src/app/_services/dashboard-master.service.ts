...
export class DashboardMasterService {
  ...
  bindDashboard(startDate, endDate) {
    ...
    return this.http.post(this.eventRootURL + '/api/company/dashboard', formData).toPromise()
      .then(
        (res: any) => {
  ...
  bindDashboardNew(startDate, endDate) {
    ...
    return this.http.post(this.eventRootURL + '/api/company/dashboard', formData);
  }
}
